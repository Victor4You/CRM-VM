 <!-- BEGIN SIDEBAR -->
  <div class="page-sidebar" id="main-menu">
    ...
    <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
      ...
      <!-- END MINI-PROFILE -->
      <!-- BEGIN SIDEBAR MENU -->
      <p class="menu-title">Navegar <span class="pull-right"><a href="javascript:;"><i class="fa fa-refresh"></i></a></span></p>

    <ul>	
      <li class="start"> <a href="home.php"> <i class="icon-custom-home"></i> <span class="title">Datos Generales</span>  </a> 
		    </li>
          ...
          <li><a href="change-password.php"><span class="fa fa-file-text-o"></span> Cambiar contraseña</a></li>
                          ...
                          <li><a href="manage-tickets.php"><span class="fa fa-ticket"></span> Administrador de Etiquetas</a></li>
                              <li ><a href="manage-quotes.php"> <span class="fa fa-tasks"></span> Administrador de actividades</a></li> 
